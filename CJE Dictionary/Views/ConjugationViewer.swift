                   ...
                   VStack {
                        ...
                        GeometryReader { overlayGeo in
                            ...
                            Image(systemName: "arrow.forward")
                                ...
                                ).frame(width: geometry.frame(in: .global).maxX - overlayGeo.frame(in: .global).minX, height: geometry.size.height - topBottomPadding, alignment: .center)
                        }
                    }
                }
